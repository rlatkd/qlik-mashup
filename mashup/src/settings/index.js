export const qlikConfig = {
  ...
  host: "61wj2gwajvv6vrz.ap.qlikcloud.com", // Qlik Sense Host
  secure: true, // Whether your host is secure of not (HTTPS / HTTP)
  port: null, // Qlik Sense site port
  prefix: "", // Prefix
  appId: "538827a5-6296-4747-b6e9-c128f56c6b69", //"0294cf88-eb02-484a-b315-cf06b45ac347" Application Id
  webIntId: "JwZ28o6yzmJd9RekINn1dhM13G-exvBo", // Web Integration Id, for connection to Qlik cloud
